...
# Read our secret from the environment variable we stored it in - this will be defined on our machine, not in any of our public code, so we can push this code up to somewhere like GitHub and nobody will know our secret
#   def secret
#     ENV["MY_SECRET"]
#   end
